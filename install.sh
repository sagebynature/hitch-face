...
cp native/zig-out/bin/hitch-face "$APP_DIR/hitch-face"
cp -R native/frontend/dist "$APP_DIR/frontend/dist"
cp -R native/assets/. "$APP_DIR/assets/"
cp native/app.zon "$APP_DIR/app.zon"
